...
class MultiTapeTuringMachine:
    ...
    def _load_machine_definition(self, filename):
        with open(filename, 'r') as file:
            # First line: machine name and tape count
            ...
            for line in file:
                ...
                # Ensure rule has enough elements
    ...
    def _get_matching_rule(self, current_symbols):
        # Find a rule matching the current state and tape symbols
        ...
        with open(output_file, 'w') as output:
            ...
            for step in range(max_steps):
              ...
              # Find applicable rule
                ...
                # Apply tape updates and head movements
                for tape_index in range(self.tape_count):
